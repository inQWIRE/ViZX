...
export let REALLY_SMALL_TEXT = (SCALE / 9).toString().concat("px");
export let SMALL_TEXT = (SCALE / 7).toString().concat("px");
export let MEDIUM_TEXT = (SCALE / 5.5).toString().concat("px");
export let LARGE_TEXT = (SCALE / 3.5).toString().concat("px");
